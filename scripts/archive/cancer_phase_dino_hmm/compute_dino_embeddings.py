"""
Step 2: Compute DINOv2 embeddings of dino_patch_px crops centered on cancer PHASE
cells (channel 1 of the type-separated tracks).
...
For each crop:
  ...
  - extract a dino_patch_px patch centered on each cancer phase-cell centroid (edge padded)
...
Column ordering matches cancer_cell_ids.npy / cancer_phase_centroids.npy from Step 1.
