...
for crop in crop_ids:
    ...
    # Determine cell IDs from all frames.  Cells appearing only at t=0
    # will be filtered out by the min_t requirement in fit_arhmm.py.
    ...
    # NOTE: All 50 frames are kept.  The AR warmup logic in fit_arhmm.py
    # marks each cell's first active frame as inactive for inference while
